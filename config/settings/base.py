"""SmartHR360 Policy-Gen service — base settings.

AI HR policy generator microservice (Module 4): social-data analytics,
policy impact simulation, LLM-generated recommendations (Groq).
...
SPECTACULAR_SETTINGS = {
    "TITLE": "SmartHR360 Policy-Gen API",
    "DESCRIPTION": (
        "AI HR policy generator (Module 4): analytics, policy impact "
        "simulation and AI recommendations."
    ),
    "VERSION": "1.0.0",
